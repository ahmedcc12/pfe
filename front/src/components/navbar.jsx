...
<img src={logo} alt="logo" className="h-8 w-32" />
        ...
        <div className="flex items-center gap-4">
          ...
          {auth.role === "admin" ? (
          <Link to="/admin" className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow"
          ...
          <Link to="/Profile" className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow"
             variant="text" size="sm">
              Profile
          </Link>
          </div>
