...
const NotificationBell = () => {
    ...
    useEffect(() => {
        const unreadNotifications = async () => {
            try {
                const response = await axiosPrivate.get(`/notifications/unread/${auth.userId}`,
    ...
    const handleClear = async () => {
        try {
            await axiosPrivate.delete(`/notifications/clear/${auth.userId}`);
            setNotifications([]);
    ...
    return (
        <div>
            ...
            >
                ...
                <div className='mb-4'>
                    <Button onClick={handleCloseMenu} style={{ position: 'absolute', top: 0, right: 0 }} disableRipple >
