        ...
        <div className="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
          ...
          <form className="my-10" onSubmit={handleResetPassword}>
            <div className="flex flex-col space-y-5">
              ...
              <button
                type="submit"
                className="w-full py-3 font-medium text-white primary hover:bg-red-600 rounded-lg border-indigo-500 hover:shadow inline-flex space-x-2 items-center justify-center"
              >
                <svg
